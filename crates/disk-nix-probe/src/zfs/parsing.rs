...
fn parse_datasets(bytes: &[u8]) -> Result<Vec<ZfsRow>, ProbeError> {
    ...
    for line in text.lines().filter(|line| !line.trim().is_empty()) {
        ...
        rows.push(ZfsRow {
            ...
            keyformat: fields.get(12).and_then(|value| nonempty_dash(value)),
            keylocation: fields.get(13).and_then(|value| nonempty_dash(value)),
            keystatus: fields.get(14).and_then(|value| nonempty_dash(value)),
            volsize: fields.get(15).and_then(|value| nonempty_dash(value)),
            recordsize: fields.get(16).and_then(|value| nonempty_dash(value)),
            dedup: fields.get(17).and_then(|value| nonempty_dash(value)),
            checksum: fields.get(18).and_then(|value| nonempty_dash(value)),
            copies: fields.get(19).and_then(|value| nonempty_dash(value)),
            sync: fields.get(20).and_then(|value| nonempty_dash(value)),
            primarycache: fields.get(21).and_then(|value| nonempty_dash(value)),
            secondarycache: fields.get(22).and_then(|value| nonempty_dash(value)),
            atime: fields.get(23).and_then(|value| nonempty_dash(value)),
            relatime: fields.get(24).and_then(|value| nonempty_dash(value)),
            snapdir: fields.get(25).and_then(|value| nonempty_dash(value)),
            acltype: fields.get(26).and_then(|value| nonempty_dash(value)),
            xattr: fields.get(27).and_then(|value| nonempty_dash(value)),
        });
    }
