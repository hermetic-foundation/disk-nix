...
let
  ...
  declarativeHandoffImportPatch = pkgs.writeText "disk-nix-declarative-handoff-import.patch" ''
    # Generated by services.disk-nix.
    # Review before applying. This patch is intentionally not applied
    # automatically because importing the handoff module changes the declarative
    # storage state that NixOS will enforce.
    --- a/configuration.nix
    +++ b/configuration.nix
    @@
     {
