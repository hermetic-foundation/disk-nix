...
manual-review flags, and notes. These command plans are intentionally advisory
until the executor can compare desired state with the live probed graph and
