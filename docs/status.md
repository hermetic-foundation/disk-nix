...
- Explicitly enabled smoke integration harnesses for loop devices, Btrfs,
  ...
  failure, partition grow failure, NFS remount failure, iSCSI logout and login
  failures, LVM cache attach and detach failures, VDO grow failure, VDO and bcache property
