...
snapshot identities, duplicate iSCSI target identities, duplicate LUN host
paths, and duplicate NFS export path/client pairs.
...
targets, concrete snapshot identities, iSCSI target identities, LUN host paths,
and NFS export path/client pairs before generating an apply plan.
