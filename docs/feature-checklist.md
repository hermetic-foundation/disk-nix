...
- [ ] **Partial:** Broader destructive and failure-path integration tests are
  ...
  filesystem repair, filesystem property, swap label, zram rescan, zram property inventory, loop rescan, backing-file rescan, backing-file grow, device-mapper rename,
  ZFS dataset rename,
